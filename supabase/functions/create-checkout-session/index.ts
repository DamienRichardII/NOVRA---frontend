...
const SHIPPING = {
  standard: { label: 'Livraison standard', cents: 490, freeFrom: 8000 },
  express:  { label: 'Livraison express',  cents: 990, freeFrom: null },
  pickup:   { label: 'Point relais',       cents: 290, freeFrom: null }
};
...
Deno.serve(async (req) => {
  ...
  if (!Object.prototype.hasOwnProperty.call(SHIPPING, method)) return fail('Mode de livraison inconnu.');
